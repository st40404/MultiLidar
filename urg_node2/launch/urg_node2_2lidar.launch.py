...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('scan_topic_name_1st', default_value='scan_1st'), #IARC_front
        DeclareLaunchArgument('scan_topic_name_2nd', default_value='scan_2nd'), #IARC_back
        lifecycle_node_1st,
        lifecycle_node_2nd,
