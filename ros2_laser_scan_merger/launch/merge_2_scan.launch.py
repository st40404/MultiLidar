...
def generate_launch_description():
    ...
    pointCloutFrameId = LaunchConfiguration('pointCloutFrameId', default="mobile_base_link")
    

    #parameter for the first laserscan, feel free to duplicate and rename for other laserscans
    scanTopic1 = LaunchConfiguration('scanTopic1', default="scan_1st")
    laser1XOff = LaunchConfiguration('laser1XOff', default=0.38)
    laser1YOff = LaunchConfiguration('laser1YOff', default=0.28)
    laser1ZOff = LaunchConfiguration('laser1ZOff', default=0.03)
    laser1Alpha = LaunchConfiguration('laser1Alpha', default=45.0)
    # laser1AngleMin = LaunchConfiguration('laser1AngleMin', default=-360.0)
    # laser1AngleMax = LaunchConfiguration('laser1AngleMax', default=360.0)
    # laser1AngleMin = LaunchConfiguration('laser1AngleMin', default=-135.0)
    # laser1AngleMax = LaunchConfiguration('laser1AngleMax', default=135.0)
    ...
    # scanTopic2 = LaunchConfiguration('scanTopic2', default="scan_2nd")
    scanTopic2 = LaunchConfiguration('scanTopic2', default="scan_2nd")
    laser2XOff = LaunchConfiguration('laser2XOff', default=-0.38)
    laser2YOff = LaunchConfiguration('laser2YOff', default=-0.28)
    laser2ZOff = LaunchConfiguration('laser2ZOff', default=0.03)
    laser2Alpha = LaunchConfiguration('laser2Alpha', default=225.0)
    # laser2AngleMin = LaunchConfiguration('laser2AngleMin', default=-360.0)
    # laser2AngleMax = LaunchConfiguration('laser2AngleMax', default=360.0)
    # laser2AngleMin = LaunchConfiguration('laser2AngleMin', default=-135.0)
    # laser2AngleMax = LaunchConfiguration('laser2AngleMax', default=135.0)
    ...
    laser2G = LaunchConfiguration('laser2G', default=255)
    laser2B = LaunchConfiguration('laser2B', default=0)
